...
def update_train_log(eval_test, runtime, MODEL_VERSION, test=False):
    """
    ...
    header = ['unique_id', 'timestamp', 'eval_test', 'param_dim', 'model_version', 'runtime']
    write_header = False
    ...
    with open(logfile, 'a') as csvfile:
        ...
        to_write = map(str, [uuid.uuid4(), time.time(), eval_test,
